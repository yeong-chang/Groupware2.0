...
<%
    ...
    String pageHtml =
            StringUtil.renderingPager(maxNum,
                    ...
                    pageSize,
                    bottomCount,
                    cp+"/board/marketing.do", "pageDoRetrieve");
...
<body>
    ...
    <div class="main-content">
        <h1 class="board-title">마케팅 게시판</h1>
        ...
        <table>
            ...
            <c:forEach var="boardVO" items="${list}">
                <c:if test="${boardVO.article_board_div == 50}">
                    <tr>
    ...
    <script src="/ehr/resources/assets/js/board/marketingboard_page.js"></script> <!-- 여기에 스크립트 파일 경로 -->
</body>
</html>
