...
<%
    ...
    String pageHtml =
            StringUtil.renderingPager(maxNum,
                    ...
                    pageSize,
                    bottomCount,
                    cp+"/board/free.do", "pageDoRetrieve");
...
<body>
    ...
    <div class="main-content">
        ...
        <table>
            ...
            <tbody>
                <c:forEach var="boardVO" items="${list}">
                    <c:if test="${boardVO.article_board_div == 20}">
                        <tr>
        ...
        <% out.print(pageHtml); %>
        <!-- 게시글 작성 버튼 -->
        <a href="freewrite.do"><button>자유 게시글 작성</button></a>
    </div>
    <script src="/ehr/resources/assets/js/board/freeboard_page.js"></script> <!-- 여기에 스크립트 파일 경로 -->
</body>
</html>
