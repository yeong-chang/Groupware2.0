...
<%
    ...
    String pageHtml =
            StringUtil.renderingPager(maxNum,
                    ...
                    pageSize,
                    bottomCount,
                    cp+"/board/development.do", "pageDoRetrieve");
...
<head>
   ...
   <!--  <style>
    ...
    <link rel="stylesheet" href="/resources/assets/css/main/main.css">
</head>
<body>
    ...
    <div class="main-content">
        ...
        <table>
            ...
            <c:forEach var="boardVO" items="${list}">
                    <c:if test="${boardVO.article_board_div == 30}">
                        <tr>
                            <td>${boardVO.article_no}</td>
                            <td><a href="boardDetail.do?article_no=${boardVO.article_no}">${boardVO.article_title}</a></td>
                            <td>${boardVO.userVO.name}</td>
                            <td>${boardVO.article_reg_date}</td>
                        </tr>    
                    </c:if>
                </c:forEach>
            </tbody>
    ...
    <script src="/ehr/resources/assets/js/board/developmentboard_page.js"></script> <!-- 여기에 스크립트 파일 경로 -->
</body>
</html>
